...
public class Organism : MonoBehaviour
{
    ...
    {
        GameObject gameObject = Instantiate(lineSkill.gameObject, transform.position + new Vector3(0, 0.5f, 0) + transform.forward*1f, Quaternion.identity);//Vector3(0, 1, 0)可以瞬移
    ...
    public void DownSkill()//DownSkill
    {
        ...
        {
            Vector3 randomPosition = closeone.transform.position + new Vector3(Random.Range(-3, 3), 20, Random.Range(-3, 3));
